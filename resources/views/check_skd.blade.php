        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        <label>Pasien</label>
                        <select disabled name="patient_id" class="form-control @error('patient_id') is-invalid @enderror">
            ...
            <div class="row">
                <div class="col text-right">
                    ...
                    <a href="{{ asset('pdfs/' . $signed_skd->pdf) }}" target="__blank" class="btn btn-outline-danger"><i
                            class="fas fa-file-pdf mr-2"></i>Lihat PDF
                    </a>
                </div>
            </div>
        </div>
